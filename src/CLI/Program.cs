...
namespace CLI
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var installationMenuOption = new CLIOption() { Name = "Show installation options", Command = WorkloadInstallationMenu.Show };
            var movementMenuOption = new CLIOption() { Name = "Show movement options", Command = WorkloadMovementMenu.Show };
